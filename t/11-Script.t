...
my @data = (
	...
	{
		addresses => [
			'34AJKytQeTV9PtMA2t5ixFtuMhrhQ2bsuN',
		],
		serialized => '4d0e01' . '01' x 270,
		script => sub {
			shift->push_bytes("\x01" x 270);
		},
	},
	{
		'addresses' => [
	...
	},
	{
		...
		serialized => '5121032b505cb176689d04c3c89590e46ac8bcac600ba3a45cc8a6f3dfcadea2e827b221024fad8c81793a1f2403fe9c8b1bbcdfe3bd2914b4419d182d5e91f0c343c9417052ae',
		'script' => sub {
			shift
			->add_operation('OP_1')
			->push_bytes(
