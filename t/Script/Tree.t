...
subtest 'should allow finding element by hash if the id was not passed' => sub {
	my $tree = btc_script_tree->new(
		tree => [
			{
				leaf_version => 192,
	...
	is to_format [
		hex => $tree->get_tapleaf_hash([hex => 'f154e8e8e17c31d3462d7132589ed29353c6fafdb884c5a6e04ea938834f0d9d'])
		],
		'f154e8e8e17c31d3462d7132589ed29353c6fafdb884c5a6e04ea938834f0d9d', 'hash of the unnamed element ok';

	is to_format [hex => $tree->get_tapleaf_hash('named')],
